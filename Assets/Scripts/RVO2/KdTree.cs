...
namespace RVO
{
    ...
    internal class KdTree
    {
         ...
         * </param>
         * <param name="end">The ending agent k-D tree node index.结束时的代理K-D树节点索引</param>
         * <param name="node">The current agent k-D tree node index.当前代理的K-D树节点索引</param>
         */
         ...
         * specified agent.计算指定代理的障碍物邻居的递归方法</summary>
         *
         * <param name="agent">The agent for which obstacle neighbors are to be
         * computed.</param>
         * <param name="rangeSq">The squared range around the agent.</param>
